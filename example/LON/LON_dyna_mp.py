...
env = irsim.make('/home/pengchen/Research/NeuPAN/example/multipoly_dyna/acker/env.yaml', display=True)
neupan_planner = neupan.init_from_yaml('example/multipoly_dyna/acker/planner.yaml')
...
if __name__ == "__main__":
    ...
    for epoch in range(epoch_num):
        ...
        total_loss, arrive = train_one_epoch(max_steps=1000, render=True) 
